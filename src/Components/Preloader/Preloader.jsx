...
let Preloader = (props)=> {
    ...
    return (
        ...
        <circle className="pl__ring" cx="100" cy="100" r="82" fill="none" stroke="url(#pl-grad1)" strokeWidth="36" strokeDasharray="0 257 1 257" strokeDashoffset="0.01" stroke-linecap="round" transform="rotate(-90,100,100)" />
